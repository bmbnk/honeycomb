...
def test_after_load_game_state_equals_gamestring(game: Game, gamestring: str):
...
def test_passing_while_having_moves_raises_invalidmove(
...
def test_status_represents_valid_game_state(game: Game, gamestring: str):
    game.load_game(gamestring)
